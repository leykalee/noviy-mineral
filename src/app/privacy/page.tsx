  ...
  return (
    <div className="container-page pb-16 pt-6">
      ...
      <div className="max-w-[70ch] space-y-5 text-[16px] leading-relaxed text-muted-foreground">
        <p>
          Форма заявки на сайте запрашивает телефон, удобный способ связи и, по желанию, описание
          того, какой экземпляр вы ищете. Эти данные нужны только чтобы ответить на заявку.
        </p>
        ...
        <p>
          Пока приём заявок работает в тестовом режиме: почтовый сервис магазина не подключён,
          поэтому отправленная форма не уходит адресату, а фиксируется только в журнале сервера.
          Интерфейс сообщает об этом сразу после отправки.
        </p>
